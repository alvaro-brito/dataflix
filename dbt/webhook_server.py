#!/usr/bin/env python3
"""
Webhook Server to execute dbt when Airflow finishes ELT
...
def serve_docs_index():
    ...
    try:
        ...
        return jsonify({'status': 'error', 'message': 'Documentation not available'}), 404
...
def webhook():
    """
    Webhook endpoint called by Airflow after finishing ELT
